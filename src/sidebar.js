module.exports = Sidebar = () => ({
  ".sidebar": {
    "@apply fixed top-0 bottom-0 left-0 z-40 h-full overflow-hidden outline-none w-full transition ease-out bg-white duration-100 overflow-y-auto transform origin-left -translate-x-full p-2 pb-20": {},
  },

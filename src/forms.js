module.exports = Forms = () => ({
  ...
  ".tag-input": {
    "@apply mt-1 block w-full appearance-none bg-white border-2 border-solid border-gray-300 rounded px-3 py-2 text-base leading-normal transition-colors duration-150 ease-in shadow-none text-gray-900": {},
  },
  ".tag-icon": {
    "@apply relative": {},
  },
  ...
  ".tag-select": {
    "@apply mt-1 block w-full appearance-none bg-white border-2 border-solid border-gray-300 rounded pl-3 pr-10 py-2 text-base leading-normal transition-colors duration-150 ease-in shadow-none text-gray-900 bg-no-repeat cursor-pointer": {},
  ...
  ".tag-range": {
    "@apply mt-1 block w-full appearance-none bg-white border-2 border-solid border-gray-300 rounded px-3 py-3 text-base leading-normal transition-colors duration-150 ease-in shadow-none text-gray-900": {},
  },
  ...
  ".tag-range::-webkit-slider-thumb": {
    "@apply appearance-none transition-colors duration-150 ease-in rounded border-none bg-primary -mt-2 h-6 w-4": {},
  },
  ...
  ".tag-range:disabled::-webkit-slider-thumb": {
    "@apply bg-primary-light cursor-not-allowed": {},
  },
  ...
  // Readonly
  ".tag-input[readonly]": {
    "@apply bg-gray-300 border-gray-300 cursor-default opacity-100": {},
  },
  // Validation
  ".tag-validation": {

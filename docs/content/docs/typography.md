...
Kutty uses [Tailwind's Typography Plugin](https://github.com/tailwindlabs/tailwindcss-typography), check out their [documentation](https://github.com/tailwindlabs/tailwindcss-typography) for more information.
